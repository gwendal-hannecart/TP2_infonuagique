...
// source: IMC.proto
#ifndef GRPC_IMC_2eproto__INCLUDED
#define GRPC_IMC_2eproto__INCLUDED
...
class imcService final {
 public:
  static constexpr char const* service_full_name() {
    return "imcPersonne.imcService";
  }
  class StubInterface {
   public:
    ...
    ExperimentalWithCallbackMethod_testHelloWorld() {
      ...
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(0,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::imcPersonne::imcPersonneRequest, ::imcPersonne::imcResponse>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
...
#endif  // GRPC_IMC_2eproto__INCLUDED
