...
std::unique_ptr< TestHelloWorldService::Stub> TestHelloWorldService::NewStub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options) {
  (void)options;
  std::unique_ptr< TestHelloWorldService::Stub> stub(new TestHelloWorldService::Stub(channel));
  return stub;
}

TestHelloWorldService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
